    ...
    <div className="mt-10 py-10 border-t border-gray-300 text-center">
      <div className="flex flex-wrap justify-center">
        <div className="w-full lg:w-9/12 px-4">
          ...
          Our dedicated instructors play a crucial role in our competitive learning platform, shaping the educational experience and empowering learners to acquire new skills and knowledge. As instructors, they have the opportunity to create engaging and comprehensive courses that inspire and guide our users towards their learning goals.
          </p>
