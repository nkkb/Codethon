    ...
    <div className="mt-10 py-10 border-t border-gray-300 text-center">
      <div className="flex flex-wrap justify-center">
        <div className="w-full lg:w-9/12 px-4">
          ...
          Developers in our competitive learning platform embrace challenges, accumulate points, and unlock new levels of expertise, all while being part of a supportive community of passionate learners.
