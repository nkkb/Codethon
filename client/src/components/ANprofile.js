...
export default function ANprofile() {
    ...
    onSubmit: async (values) => {
      ...
      if (Object.keys(errors).length === 0) {
        ...
        try {
          ...
          toast.success(<b>Update Successful...!</b>);
        } catch (error) {
    ...
    <div className="mt-10 py-10 border-t border-gray-300 text-center">
      <div className="flex flex-wrap justify-center">
        <div className="w-full lg:w-9/12 px-4">
          ...
          Our system's analyst is an integral part of our competitive learning platform, bringing a data-driven approach to optimize and enhance the learning experience for our users. As an analyst, their primary responsibility is to analyze and interpret the vast amount of data generated by user interactions within the platform.
          </p>
