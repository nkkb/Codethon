...
import { CreateGcourse,challenge } from '../helper/helper'
 ...
 /* useEffect(() => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (!values.TypeofParticipation) {
        errors.TypeofParticipation = 'Type of Participation is required';
      }
      ...
      if (!values.Examples) {
        errors.Examples = 'Examples is required';
      }
      ...
      if (Object.keys(errors).length === 0) {
        // Perform the challenge creation operation
        values = {
          ...values,
          QCM: question,
        };
...
<ThemeProvider theme={theme}>
    ...
    <div class="flex flex-wrap mb-4 w-full h-full">
      ...
      <div class="mb-4 w-1/2 pr-2">
        ...
        <input
         {...formik.getFieldProps('ChallengeName')}
