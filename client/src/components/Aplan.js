  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (Object.keys(errors).length === 0) {
        ...
        try {
          // Perform the plan creation operation
          await PlanC(values);
  ...
  const formikEdit = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (Object.keys(errors).length === 0) {
        // Submit the form and handle success/failure
        try {
          // Perform the plan editing operation
          await PlanCEdit(values);
                       ...
                       <Dropdown.Item>
                         <a
                           href="#" onClick={() => {
                            ...
                            formik.setFieldValue('ChallengeName', challenge.ChallengeName );
                       ...
                       <Dropdown.Item>
                         <a
                           href="#" onClick={() => {
                            ...
                            formikEdit.setFieldValue('ChallengeName', challenge.ChallengeName );
                       ...
                       <Dropdown.Item>
                         <a
                           href="#" onClick={() => {
                            ...
                            let registerPromise = PlanCDelete( values );
...
<Transition appear show={isOpen} as={Fragment}>
      ...
      <div class="mb-4">
          ...
          <input {...formikEdit.getFieldProps('ChallengeName')} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="ChallengeName" type="text" placeholder="ChallengeName" />
        </div>
        <div class="mb-4">
          <label class="block text-white  font-bold mb-2" for="period">
      ...
      />
        ...
        <div class="mb-6">
          <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="submit">
            edit the plans for the Challenge
          </button>
</div>
</form>
                </Dialog.Panel>
