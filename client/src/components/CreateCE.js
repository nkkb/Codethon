...
import { UpdateGcourse } from '../helper/helper'
...
export default function CreateCE() {
   ...
   const formik = useFormik({
    initialValues : {
      ...
      onSubmit : async values => {
          ...
          let registerPromise = UpdateGcourse(values)
          toast.promise(registerPromise, {
            loading: 'updating...',
            success : <b>Gcourse upadted...!</b>,
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8080/api/Gcourse/${localStorage.getItem('Coursename')}`)
          .then(response => {
            setGcourse(response.data);
            console.log(response.data);
                formik.setFieldValue('Course', response.data.Course );
                formik.setFieldValue('Description', response.data.Description );
                formik.setFieldValue('PDescription', response.data.PDescription );
                formik.setFieldValue('Hint', response.data.Hint );
                formik.setFieldValue('Test', response.data.Test );
                formik.setFieldValue('code', response.data.code );
                formik.setFieldValue('Solution', response.data.Solution );
                formik.setFieldValue('question', response.data.question );
                formik.setFieldValue('A', response.data.A );
                formik.setFieldValue('B', response.data.B );
                formik.setFieldValue('C', response.data.C );
                formik.setFieldValue('D', response.data.D );
                formik.setFieldValue('S', response.data.S );
                setCode(response.data.Test);
          })
          .catch(error => {
            console.log(error);
          });
