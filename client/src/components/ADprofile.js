  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (Object.keys(errors).length > 0) {
        ...
        // No validation errors, update the user
    ...
    <div className="mt-10 py-10 border-t border-gray-300 text-center">
      <div className="flex flex-wrap justify-center">
        <div className="w-full lg:w-9/12 px-4">
          ...
          Our system's administrator plays a crucial role in our competitive learning platform. They oversee the development and management of the platform, ensuring its smooth operation and continuous improvement. The administrator works closely with the developers to address challenges, implement new features, and enhance the user experience.
          </p>
